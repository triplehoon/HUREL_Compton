    ...
    class LACCMLPE
    {
        ...
        private void loadLUT(string FileName)
        {
            ...
            try
            {
                ...
                Console.WriteLine("LUT Done!");
            }
            catch
            {
                Console.WriteLine("Reading LUT Error");
            }
        }      
        ...
        public double[] PosAndEEstimate(short[] pmtADCValue)
        {
            ...
            //sw.Stop();
            //Console.WriteLine("0: vvvvvvvvvvvvvvvvvvvvvvvvvvvv " + sw.ElapsedTicks);
        ...
        private void MuArrays()
        {
            ...
            Console.WriteLine("XY Logmu Table is done.");
        }
